...
from electrum_gmc.util import print_error, InvalidPassword
from electrum_gmc.bitcoin import is_valid, COIN
from electrum_gmc.wallet import NotEnoughFunds
from electrum_gmc import WalletStorage, Wallet

Gdk.threads_init()
APP_NAME = "Electrum-GMC"
import platform
MONOSPACE_FONT = 'Lucida Console' if platform.system() == 'Windows' else 'monospace'

from electrum_gmc.util import format_satoshis, parse_URI
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        title = 'Electrum-GMC ' + self.wallet.electrum_version + '  -  ' + self.config.path
    ...
    def do_send(self, w, data):
        ...
        if not is_valid(to_address):
            self.show_message( "invalid gamecredits address:\n"+to_address)
            return
