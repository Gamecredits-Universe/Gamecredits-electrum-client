import select, time, electrum_gmc as electrum, Queue
from electrum_gmc import Connection, Interface, SimpleConfig
from electrum_gmc.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    server = 'electrum-gmc.bysh.me:50002:s'
